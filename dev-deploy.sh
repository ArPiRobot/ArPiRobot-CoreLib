...
scp -r cpp_library/build/libarpirobot-core.so cpp_library/build/testrobot python_bindings/arpirobot/ python_bindings/testrobot-py start-cpp.sh start-py.sh  pi@$ROBOT_IP:/home/pi/CPPLibTest
