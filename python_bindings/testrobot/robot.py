...
from arpirobot.arduino.sensor import VoltageMonitor, IRReflectorModule
...
class Robot(BaseRobot):
    ...
    def periodic(self):
        Logger.log_info("Detected = " + str(self.enc.get_digital_value()))
        self.feed_watchdog()